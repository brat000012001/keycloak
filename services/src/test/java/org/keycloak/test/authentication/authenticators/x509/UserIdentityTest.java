...
public class UserIdentityTest {
    ...
    public void testUserIdentityFromSubjectDN_Email() throws Exception {
        ...
        verify(flowContext).setUser(eq(user));
        verify(events,never()).error(any());
        verify(clientSession).setAuthNote(eq(AbstractUsernameFormAuthenticator.ATTEMPTED_USERNAME),eq("username@example.com"));
        verify(flowContext,never()).failure(any(),any());
        verify(flowContext).success();
    ...
    public void testUserIdentityFromSubjectDN_RegularExpression() throws Exception {
        ...
        verify(flowContext).setUser(eq(user));
        verify(events,never()).error(any());
        verify(clientSession).setAuthNote(eq(AbstractUsernameFormAuthenticator.ATTEMPTED_USERNAME),eq("CN="+CERTIFICATE_SUBJECTDN));
        verify(flowContext,never()).failure(any(),any());
        verify(flowContext).success();
    ...
    public void testUserIdentityFromIssuerDN_CN() throws Exception {
        ...
        verify(flowContext).setUser(eq(user));
        verify(events,never()).error(any());
        verify(clientSession).setAuthNote(eq(AbstractUsernameFormAuthenticator.ATTEMPTED_USERNAME),eq("IDP"));
        verify(flowContext,never()).failure(any(),any());
        verify(flowContext).success();
    ...
    public void testUserIdentityFromIssuerDN_Email() throws Exception {
        ...
        verify(flowContext).setUser(eq(user));
        verify(events,never()).error(any());
        verify(clientSession).setAuthNote(eq(AbstractUsernameFormAuthenticator.ATTEMPTED_USERNAME),eq("issuer@example.org"));
        verify(flowContext,never()).failure(any(),any());
        verify(flowContext).success();
    ...
    public void testUserIdentityFromIssuerDN_RegularExpression() throws Exception {
        ...
        verify(flowContext).setUser(eq(user));
        verify(events,never()).error(any());
        verify(clientSession).setAuthNote(eq(AbstractUsernameFormAuthenticator.ATTEMPTED_USERNAME),eq("CN="+ROOT_SUBJECTDN));
        verify(flowContext,never()).failure(any(),any());
        verify(flowContext).success();
